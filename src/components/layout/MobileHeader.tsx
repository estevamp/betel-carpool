import { Menu, Bell, Car, HelpCircle } from "lucide-react";
...
export function MobileHeader({ onMenuClick, onTourClick }: MobileHeaderProps) {
  const { requestPermission, isSubscribed } = useOneSignal();
